...
export async function DELETE(_req, { params }) {
  try {
    ...
    await prisma.classSubjectTutor.delete({
      where: { id },
    });
    ...
    console.error("[DELETE]/class-subject-tutors/[id]", error);
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            "Data tidak dapat dihapus karena masih digunakan pada entitas lain.",
        },
        { status: 409 }
      );
    }
